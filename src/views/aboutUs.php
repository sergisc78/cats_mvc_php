...
<body>
    ...
    <div class="container catlovers-location text-center  justify-content-center align-items-center " id="aboutUs">
        <div class="row">
            <div class="col">
        ...
        <h3>If you want to meet us,here we are !</h3>
        <br />
        <h3>This is our address:</h3>
        <h3> C/Amílcar 265, Barcelona</h3>
    </div>
    ...
    <script>
        var map = L.map("mapid").setView([41.42896416, 2.17208236], 69);

        L.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png", {
            attribution: '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors',
        }).addTo(map);

        L.marker([41.42896416, 2.17208236])
            .addTo(map)
