...
<div class="container mt-5" style="width: 15000px;">
    <div class="row  justify-content-center align-items-center ">
        <div class="col-5" id="editcat">
            <div class="card">
                <div class="card-body">
                    <form class="text-center" action="<?php echo URL ?>/admin/deleteCat/<?php echo $data['id'] ?>" method="post" enctype="multipart/form-data">
                        <h3 class="mb-4 text-center fs-1">Delete <?php echo $data['cat_name'] ?> ? </h3><a href="<?php echo URL ?>/admin/dashboard" class="btn btn-primary">Dashboard</a>
                        ...
                        <div class="d-grid gap-2 mt-4">
                            <form action="dashboard.php" method="post">
                                <button type="submit" name="delete" class="btn btn-dark btn-lg border-0 rounded-0">Are you sure you want to delete this cat?</button>
                            </form>
                        </div>
                        <br>
