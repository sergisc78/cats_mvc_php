...
<div class="container mt-5" style="width: 15000px;">
    <div class="row  justify-content-center align-items-center ">
        <div class="col-5" id="editcat">
            <div class="card">
                <div class="card-body">
                    <form class="text-center" action="<?php echo URL ?>/admin/user/view-user-interested/<?php echo $data['id'] ?>" method="post">
                        <h3 class="mb-4 text-center fs-1">View / Edit User Request</h3><a href="<?php echo URL ?>/admin/user/users-interested" class="btn btn-primary">Back to users interested </a>
                        <div class="form-group mt-3">
                            <input type="hidden" class="form-control" value="<?php echo $data['id'] ?>" name="id" id="id" placeholder="ID">
                        </div>
                        <div class="form-group mt-3">
                            <label for="name" class="form-label">Username</label>
                            <input class="form-control" readonly name="username" type="text" id="username" value="<?php echo $data['username'] ?>">
                        </div>
                        <div class="form-group mt-3">
