...
<div class="container mt-5" style="width: 15000px;">
    <div class="row  justify-content-center align-items-center ">
        <div class="col-5" id="editcat">
            <div class="card">
                <div class="card-body">
                    <form class="text-center" action="<?php echo URL ?>/admin/user/deleteUser/<?php echo $data['id'] ?>" method="post">
                        <h3 class="mb-4 text-center fs-1">Delete <?php echo $data['username'] ?>?</h3><a href="<?php echo URL ?>/admin/user/users" class="btn btn-primary">Users</a>
                        ...
                        <div class="d-grid gap-2 mt-4">
                           <button type="submit" name="edit" class="btn btn-dark btn-lg border-0 rounded-0">Are you sure you want to delete this user?</button>
                     </div>
                        <br>
